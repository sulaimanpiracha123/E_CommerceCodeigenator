...
<head>
	...
	<!-- For iPad: -->
	<link rel="apple-touch-icon-precomposed" href="<?php echo base_url().'Asssets/images//apple-touch-icon-72x72-precomposed.png'?>">
...
<body data-offset="200" data-spy="scroll" data-target=".ow-navigation">
	<div class="main-container">
		...
		<main>
			...
			<div class="container-fluid no-left-padding no-right-padding woocommerce-checkout">
				...
				<input class="form-control" type="text" name = "name" value = "<?php echo !empty($custData['name'])?:'';?>" placeholder="Enter Name" required>
</div>
									<div class="col-md-12 form-group">
										<label>Address 1 *</label>
										<input type="text" class="form-control" name="address" value="<?php echo !empty($custData['email'])?$custData['email']:''; ?>" placeholder="Enter email" required>
										...
										<table>
											...
											<?php if($this->cart->total_items()>0){foreach($cartItems as $items){?>
												...
												<tr class="cart_item">
													...
													<td><?php echo $items['price'];?>(<?php echo $items['qty'];?></td>
	...
	<script type="text/javascript" src="<?php echo base_url().'revolution/js/jquery.themepunch.revolution.min.js?rev=5.0'?>"></script>
