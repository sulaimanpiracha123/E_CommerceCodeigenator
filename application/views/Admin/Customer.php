            ...
            <table class="table table-striped table-bordered table-hover" id="dataTables-example1">
              ...
              <tbody>
                ...
                <tr class="odd gradeX">
                  ...
                  <td class="center"><?php echo $cus['mobile']?></td>
                  <td class="center"><input type="hidden" value="0" data-id ="<?php echo $cus['id'] ?>"class = "manage_user_status"><input <?php  if($cus['status']==1){echo "checked";}?> type="checkbox"/></td>

                  <td>
                                             <a class = "btn btn-info" href = "<?php echo base_url('index.php/Users/update_customer/'.$cus['id'])?>">Update</a>
                        <a class = "btn btn-danger" href = "<?php echo base_url('index.php/Users/Delete_Customer/'.$cus['id'])?>">Delete</a>
      ...
      <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <form action = "<?php echo base_url().'index.php/Users/add_Customer'?>"class="database_operation">
              <div class="row">
