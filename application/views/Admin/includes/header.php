...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="<?php echo base_url()?>Admin_assets/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"><?php echo $this->session->userdata('admininfo')[0]['name']?></a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url().'index.php/Users/vendor'?>" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>vendor</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url().'index.php/Users/Customer'?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Customers</p>
                </a>
              </li>
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url().'index.php/Products/manage_category'?>" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Category</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url().'index.php/Products/Manage_sub_cat'?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Sub Caategory</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url().'index.php/Products/Manage_Brand'?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Brand</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url().'index.php/Products/Manage_Product'?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Products</p>
                </a>
              </li>
